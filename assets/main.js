(function () {
  ...
  var CODE = [
    ...
    [T('x', I), T('p', '</'), T('t', 'a'), T('p', '>')],
    [T('x', I), T('p', '<'), T('t', 'nav'), T('p', '>'), T('x', 'Services Portfolio About FAQ'), T('p', '</'), T('t', 'nav'), T('p', '>')],
    [T('x', I), T('p', '<'), T('t', 'a'), T('p', ' '), T('a', 'class'), T('p', '="'), T('s', 'cta'), T('p', '">'), T('x', 'Get a Quote'), T('p', '</'), T('t', 'a'), T('p', '>')],
    [T('p', '</'), T('t', 'header'), T('p', '>')],
    [],
    ...
    [T('x', I), T('p', '<'), T('t', 'h1'), T('p', '>'), T('x', 'A website that gets you calls,')],
    [T('x', I + '    '), T('x', 'built by '), T('k', 'someone you can actually phone.'), T('p', '</'), T('t', 'h1'), T('p', '>')],
    [T('x', I), T('p', '<'), T('t', 'p'), T('p', ' '), T('a', 'class'), T('p', '="'), T('s', 'lead'), T('p', '">'), T('x', 'Mobile-first sites, flat quotes.')],
    [T('x', I), T('p', '<'), T('t', 'a'), T('p', ' '), T('a', 'class'), T('p', '="'), T('s', 'btn primary'), T('p', '">'), T('x', 'Get a Quote')],
    [T('x', I), T('p', '<'), T('t', 'a'), T('p', ' '), T('a', 'class'), T('p', '="'), T('s', 'btn ghost'), T('p', '">'), T('x', 'See My Work')],
    [T('p', '</'), T('t', 'section'), T('p', '>')]
  ];
